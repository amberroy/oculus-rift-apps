...
(2) in your MyGame.js
GameManager is available as a global on the window object.

MyGame = function ( params ) {
	// set properties, etc.
};
VRPlanetChase.prototype.init = function() { 
	// initialize game, called once by GameManager 
};
VRPlanetChase.prototype.update = function() { 
	// update game, called every frame GameManager
};
