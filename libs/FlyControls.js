...
THREE.FlyControls = function ( object, domElement, params ) {
	...
	this.keydown = function( event ) {
		...
		switch ( event.keyCode ) {
			...
			// Replace Q/E Roll with Yaw (Rotate)
			//case 81: /*Q*/ this.moveState.rollLeft = 1; break; // XXX
			//case 69: /*E*/ this.moveState.rollRight = 1; break; // XXX
			case 81: /*Q*/ this.moveState.yawLeft = 1; break; // XXX
			case 69: /*E*/ this.moveState.yawRight = 1; break; // XXX
	...
	this.keyup = function( event ) {
		...
		switch ( event.keyCode ) {
			...
			// Replace Q/E Roll with Yaw (Rotate)
			//case 81: /*Q*/ this.moveState.Left = 0; break; // XXX
			//case 69: /*E*/ this.moveState.rollRight = 0; break; // XXX
			case 81: /*Q*/ this.moveState.yawLeft = 0; break; // XXX
			case 69: /*E*/ this.moveState.yawRight = 0; break; // XXX
	...
	this.mousemove = function( event ) {
		...
		//if ( this.dragToLook || this.mouseStatus > 0 ) { // XXX
		if ( this.dragToLook && this.mouseStatus > 0 ) { // XXX
